...
class YPage3ViewController: UITableViewController,SegementSlideContentScrollViewDelegate {
...
//        cell.detailTextLabel!.text = self.publishedAtArray[indexPath.row]
    ...
    func getData(){
        ...
        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDEbvqvyCf1GtIdLmMv_q8yL7y_uxevmNA&q=CNN&part=snippet&maxResults=20&order=date"
